...
class R {
    ...
    static let bonjour_service_resolve_time_out:NSTimeInterval = 10
    static let paired = "1"
    ...
    static let tcp_thread_sleep_time:NSTimeInterval = 0.5 //sleep 500 ms, ameba side seleeps 250 ms
    static let web_page_load_timeout:NSTimeInterval = 20.0
    ...
    static let ht_chart_legend_text_color = UIColor.blackColor()
    static let ht_chart_grid_background_color = UIColor.whiteColor()
    ...
    static let scl_alert_auto_dismiss_time:NSTimeInterval = 10
    ...
    //MARK: Toast Message
    static let toast_duration:NSTimeInterval = 5.0
